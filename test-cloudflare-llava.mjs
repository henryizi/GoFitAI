  ...
  try {
    const response = await fetch(
      `https://api.cloudflare.com/client/v4/accounts/${CF_ACCOUNT_ID}/ai/run/${CF_VISION_MODEL}`,
      {
        ...
        body: JSON.stringify({
          prompt: 'What food items do you see in this image? Please provide a detailed nutritional analysis including estimated calories, macronutrients, and portion sizes.',
