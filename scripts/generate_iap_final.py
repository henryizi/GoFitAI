...
def generate_image():
    ...
    font_main = ImageFont.truetype(font_path, 240)    # Massive
    font_premium = ImageFont.truetype(font_path, 220) # Massive
    font_price = ImageFont.truetype(font_path, 150)   # Larger
    font_foot = ImageFont.truetype(font_path, 85)     # Larger
    ...
    draw.rectangle([20, 20, WIDTH-20, HEIGHT-20], outline=ORANGE, width=25)
