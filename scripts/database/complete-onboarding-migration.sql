...
ALTER TABLE public.profiles 
ADD COLUMN IF NOT EXISTS exercise_frequency TEXT CHECK (exercise_frequency IN ('0', '1-3', '4-6', '7+'));
...
COMMENT ON COLUMN public.profiles.exercise_frequency IS 'User''s exercise frequency: 0, 1-3, 4-6, or 7+ sessions per week';
